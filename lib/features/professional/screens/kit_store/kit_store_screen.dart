...
class _KitStoreScreenState extends State<KitStoreScreen> {
  ...
  Future<void> _autoResumePending() async {
    ...
    if (prefs.containsKey('idempotency_purchase_kit_online')) {
      debugPrint(
        '🔄 Found pending online kit purchase, attempting auto-resume...',
      );
    }
  }
  ...
  void _openRazorpay(KitProductModel kit, int qty) async {
    ...
    try {
      final orderData = await ProfessionalApiService.createKitPaymentOrder(
        kit.id,
        qty,
      );
        ...
        MockRazorpayDialog.show(
          ...
          onFailure: (failure) {
            ...
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(
                content: Text(failure.message ?? 'Payment Cancelled'),
  ...
  void _showSuccessDialog(String title, String kitName, int qty) {
    ...
    showDialog(
      ...
      builder: (dialogCtx) => SuccessDialog(
        title: title,
        message:
            'You have successfully purchased $qty × $kitName. It will be assigned to your inventory shortly.',
        onPressed: () {
          _isDialogOpen = false;
    ...
    return Scaffold(
      ...
      body: Stack(
        children: [
                                ...
                                child: RichText(
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            '${_filteredKits.length} results for ',
          ...
          if (_purchaseState != PurchaseState.idle &&
  ...
  Widget _buildPurchaseOverlay() {
    ...
    if (_purchaseState == PurchaseState.creatingOrder)
      message = "Initiating Order...";
    if (_purchaseState == PurchaseState.processingPayment)
      message = "Awaiting Payment...";
    if (_purchaseState == PurchaseState.verifying)
              ...
              children: [
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '₹${kit.price.toStringAsFixed(0)} per kit',
                            style: GoogleFonts.poppins(
                              fontSize: 12,
                              color: const Color(0xFF9CA3AF),
                            ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              '${_walletBalance.toStringAsFixed(0)} coins',
                              style: GoogleFonts.poppins(
                                fontSize: 15,
                                fontWeight: FontWeight.w700,
                                color: const Color(0xFF111827),
                ...
                SizedBox(
                  ...
                  child: OutlinedButton(
                    onPressed: _purchaseState != PurchaseState.idle
                        ? null
                        : () async {
                            Navigator.pop(sheetCtx);
                            await Future.delayed(
