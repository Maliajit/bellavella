class AppRoutes {
  ...
  static const String proNavigation = '/professional/navigation/:id';
  static const String proActiveJob = '/professional/active-job/:id';
  static const String proArrive = '/professional/arrive/:id';
  static const String proScanKit = '/professional/scan-kit/:id';
  static const String proCollectPayment = '/professional/collect-payment/:id';
  static const String proJobComplete = '/professional/job-complete/:id';
